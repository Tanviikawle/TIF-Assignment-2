...
const RequisitionDetailsForm: React.FC<{
  ...
  setRequisitionDetails: React.Dispatch<React.SetStateAction<IRequisitionDetails>>;
  ...
  const handleFieldChange = (field: any, value: any) => {
    ...
    setRequisitionDetails({ ...values, [field]: value });
  };
    ...
    <Box width="100%" as="form" onSubmit={handleSubmit as any}>
      <Box width="100%">
        ...
        <FormSelect
          ...
          onChange={(value: any) => handleFieldChange("gender", value)}
        ...
        <FormSelect
          ...
          onChange={(value: any) => handleFieldChange("urgency", value)}
